  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        "For paste behavior, preserve the browser's native paste default action: the paste-text workflow must report event-default-prevented false and the final value must contain the inserted text. Isolate page blockers and rollback handlers without calling preventDefault on paste/beforeinput, manually inserting InputEvent.data, or replacing the native edit.",
